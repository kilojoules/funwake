"""Long-horizon seeded random-restart optimizer over the rotated lattice basin.

HYPOTHESIS: The prior single seeded rotated-lattice run was sensitive to which
feasible lattice points were sampled, but the 7000-step restart attempt stopped
short of the best basin; restoring the 8000-step horizon should keep seed 0's
known score while testing two extra feasible subsets.
AXIS: init_random_restarts with the full dual-bump adaptive gradient horizon.
