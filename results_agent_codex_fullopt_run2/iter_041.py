"""Exact-size BO grid with projection-ensemble final repair.
...
selecting among several feasibility-repair strengths should keep the best
strictly feasible version of the same polished layout.

AXIS: BO-tuned exact-size grid plus staged AL-NAdam halving, with a final
projection ensemble and no surplus-pruning or TopFarm warm-start polish.
