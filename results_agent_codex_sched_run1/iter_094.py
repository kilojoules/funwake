"""HYPOTHESIS: The dual-bump LR/alpha path should remain fixed, but slightly
higher second-moment smoothing may reduce noisy late coordinate scaling while
preserving the incumbent basin better than beta1 ramping or alpha decoupling.
AXIS: dual_bump_beta2_micro_smoothing
