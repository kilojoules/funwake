"""HYPOTHESIS: The rounded dual-bump solution may be phase-sensitive; shifting
both mobility windows a hair earlier is a distinct phase test from the previous
late/full-precision attempts while retaining the validated rounded amplitudes.
AXIS: rounded_dual_bump_center_micro_early
