"""HYPOTHESIS: A wider local constraint counter-ramp may protect the transitions
into and out of the validated late mobility bump better than peak-only pressure.
AXIS: bump_constraint_counter_ramp_wide
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    alpha_bump = jnp.exp(-0.5 * ((t - 0.692) / 0.065) ** 2)
