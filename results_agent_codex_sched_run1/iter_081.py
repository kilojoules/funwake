"""HYPOTHESIS: The transferred rounded dual-bump schedule is sensitive; a tiny
later shift of both rounded bump centers may preserve its basin while improving
the final relocation/polish handoff.
AXIS: transferred_dual_bump_center_micro_late
