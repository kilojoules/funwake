"""Ablation: iter_192 with weak penalty — 1x coupling, no late alpha ramp.
Tests whether the strong alpha coupling / terminal slam drives feasibility."""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    alpha = 1.0 * alpha0 * lr_init / jnp.maximum(lr, 1e-10)         # 1x, no ramp
