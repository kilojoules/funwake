"""HYPOTHESIS: Fresh train-branch perturbations lost AEP, so the useful
different move from the last attempt is to keep the brittle train-scale
trajectory exact and simplify the high-alpha route. The prior terminal-lock
high branch adds complexity without improving train score; a hard alpha0
router with the simple high-scale cosine pulse should retain the best train
basin and ROWP feasibility.
AXIS: exact_train_branch_with_simple_high_alpha_router_after_phase_shift_trials.
