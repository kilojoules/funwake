"""HYPOTHESIS: The best train schedule fails current ROWP only because the
normal-scale terminal boundary repair is too weak; adding a clean late alpha
tail without the earlier anti-phase dip may retain more train AEP.
AXIS: terminal_normal_repair_without_mid_alpha_dip.
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    alpha_real = alpha_real + 12.0 * alpha0 * tail_real ** 2
