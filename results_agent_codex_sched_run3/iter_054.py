"""HYPOTHESIS: A smooth alpha0-scale gate can keep the validated
high-AEP train path unchanged while routing ROWP-sized problems through a
separate high-scale repair branch, avoiding the terminal alpha-tail tradeoff
from the previous attempt.
AXIS: smooth_three_regime_alpha0_gate_with_high_scale_repair.
