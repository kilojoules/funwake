"""HYPOTHESIS: The best train trajectory is brittle to late LR and beta
perturbations; use hard alpha0 regime dispatch rather than smooth branch
interpolation so train-scale problems follow the exact high-AEP path while
low/high-scale generalization cases get dedicated repair schedules.
AXIS: hard_three_regime_alpha0_dispatch_after_failed_polish.
