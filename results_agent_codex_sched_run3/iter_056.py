"""HYPOTHESIS: Late mobility changes disturb the best train path, but a local
second-moment reset during the validated mid bump may let Adam respond to
wake-gradient changes while preserving the incumbent LR/alpha envelope and
ROWP alpha0 repair gates.
AXIS: mid_bump_beta2_reset_on_three_regime_schedule.
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    beta2_real = 0.635963 - 0.095 * real_mid
