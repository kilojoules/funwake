"""HYPOTHESIS: Direct train-branch perturbations degrade the validated basin;
preserve the exact high-AEP train envelope, but use smooth alpha0 dispatch
instead of the last attempt's hard thresholds so intermediate-scale farms
transition gradually into the ROWP repair branch.
AXIS: smooth_alpha0_dispatch_with_exact_train_envelope_after_failed_perturbations.
