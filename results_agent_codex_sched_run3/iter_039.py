"""HYPOTHESIS: The best gated schedule finishes with zero train boundary
penalty and large spacing slack, so a modestly weaker normal-scale penalty
may let objective gradients polish AEP without weakening low-scale repair.
AXIS: alpha0_gated_dual_window_with_softened_real_scale_penalty.
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    alpha_real = 2.47 * alpha0 * real_init / lr_real
    alpha_real = alpha_real + 14.25 * alpha0 * late ** 2
