"""Aggressive Nesterov search from hexagonal wind-aware layouts.

HYPOTHESIS: The previous Nesterov run was feasible and above baseline but
under-explored the basin; a larger normalized lookahead step from a true
hexagonal lattice should recover more of the wake-alignment gain while keeping
the inverse-learning-rate constraint ramp.

AXIS: nesterov_momentum plus init_hexagonal wind-aware starts; pure penalty
constraints and no TopFarm packaged solver.
