...
HYPOTHESIS: The wake-column polish is still the strongest basin opener, but
its final layout may retain small active-contact defects. A lighter contact
clique pass after column moves can harvest only feasible improvements without
replacing the successful column strategy.

AXIS: incumbent affine recovery, active-pair release, wake-column group polish,
then reduced contact-pair rotations and boundary-edge clique slides.
