"""Affine recovery with active-pair normal release.

HYPOTHESIS: Attempt 26 found a strong affine-polished basin, but active spacing
pairs can still be wake-coupled. Tiny pair-normal separation/rebalancing moves
may improve AEP where tangent-only and one-turbine moves stall.

AXIS: incumbent affine recovery followed by deterministic nearest-pair normal
release and short penalty polishing.
