"""HYPOTHESIS: The quick stress case exposes a different gradient scale than
the real train/ROWP farms. Use alpha0 as a scale gate: preserve the validated
dual-window schedule on real farms, but switch low-alpha0 cases to the tighter
terminal-repair shelf schedule that passed the stressed boundary test.
AXIS: alpha0_gated_dual_window_with_low_scale_repair
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    # Real-farm path: validated warmup + dual mobility windows.
    ...
    # Low-gradient-scale path: stronger terminal repair for tight polygons.
