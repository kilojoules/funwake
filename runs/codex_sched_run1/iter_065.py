"""HYPOTHESIS: A narrower local alpha counter-ramp may target the peak of the
mobility bump without disturbing the entry and exit phases.
AXIS: bump_constraint_counter_ramp_narrow
