...
lowering beta1 may make the late polish bump less momentum-biased and improve
the final feasible layout.
AXIS: rounded_dual_bump_beta1_slightly_lower
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    return lr, alpha, 0.229994, 0.635963
