"""HYPOTHESIS: The previous scored attempt revisited the single late-bump
counter-ramp and trailed the best history. Return to the distinct warmup
dual-bump strategy that found the strongest feasible basin: one broad mid-run
relocation, one late polish bump, inverse-LR penalty coupling, and quadratic
late penalty recovery.
AXIS: restored_dual_bump_after_failed_time_warp
