"""HYPOTHESIS: Counter-pressure around the transferred dual bumps repeatedly
hurts, so the stronger alternative is to give the objective slightly more
authority during the two mobility windows while leaving the late quadratic
penalty recovery intact.
AXIS: dual_bump_local_alpha_softening
