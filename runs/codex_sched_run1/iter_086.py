"""HYPOTHESIS: The rounded dual-bump schedule may benefit from slightly less
terminal penalty amplification, giving the final wake objective more authority
after feasibility has already been established.
AXIS: rounded_dual_bump_slightly_softer_late_alpha
