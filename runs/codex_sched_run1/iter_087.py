"""HYPOTHESIS: The rounded dual-bump schedule may need a slightly narrower
mid-run mobility window to reduce excess relocation while keeping the late
polish bump unchanged.
AXIS: rounded_dual_bump_narrow_mid_window
