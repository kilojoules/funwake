"""HYPOTHESIS: A previously optimized warmup plus dual-bump schedule may
transfer into this run and outperform the single late Gaussian backbone by
making one broad mid-run relocation and one terminal polish movement.
AXIS: transferred_optimized_warmup_dual_bump
