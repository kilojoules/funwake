"""HYPOTHESIS: Hard terminal freezing loses needed boundary repair. A softer
terminal trust-region taper may keep the rounded dual-bump basin while reducing
only the final high-penalty drift that can trade away wake quality.
AXIS: dual_bump_terminal_soft_taper
