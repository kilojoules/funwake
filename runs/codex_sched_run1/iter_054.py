"""HYPOTHESIS: The late bump may benefit from a locally stronger constraint
counter-ramp rather than changing LR, keeping the mobility pulse feasible.
AXIS: bump_constraint_counter_ramp
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    alpha = alpha + 1.2 * alpha0 * bump_shape
