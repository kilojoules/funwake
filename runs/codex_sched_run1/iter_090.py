"""HYPOTHESIS: Local ablations around the transferred dual-bump schedule showed
that center shifts, added alpha pressure, and Adam-memory tweaks reduce target
or held-out feasibility. Restore the rounded dual-bump schedule exactly as the
robust incumbent for final scoring.
AXIS: restored_rounded_dual_bump_after_ablation
