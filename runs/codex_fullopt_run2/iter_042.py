"""Exact-size BO grid with final learning-rate ensemble.
...
stronger basin. Its fixed final projection may still discard a little AEP, so
selecting among several final polishing learning rates and feasibility-repair
strengths should keep the best strictly feasible version of the same basin.

AXIS: BO-tuned exact-size grid plus staged AL-NAdam halving, with a final
learning-rate ensemble, projection ensemble, and no surplus-pruning or TopFarm
warm-start polish.
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    projected = [project(cur_x[0], cur_y[0], *spec) for spec in proj_specs]
