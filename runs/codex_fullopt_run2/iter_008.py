"""Penalty-only custom Adam with three aggressive starts.

HYPOTHESIS: The prior penalty-only run improved sharply but softened the dense
third start; applying the stronger schedule to all three starts should recover
the best basin while keeping the implementation hand-written.
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    for init_x, init_y, solver in (
        ...
        (starts[2][0], starts[2][1], solve_main),
    ):
