"""Relaxed projected custom Adam optimizer.

HYPOTHESIS: The first custom Adam run lost AEP by keeping too much spacing and
boundary slack; relaxing the projection target should recover denser layouts.
