"""CMA surplus-grid search with final projection ensemble.

HYPOTHESIS: The incumbent marginal-pruned layout may lose a small amount of AEP
in the final fixed feasibility repair; selecting among several projection
strengths should preserve more of the polished layout while still returning a
strictly feasible farm.
AXIS: cmaes covariance-adaptation search over surplus-grid parameters plus
marginal surplus pruning, final AL NAdam, and a feasibility projection
ensemble selected by objective value.
