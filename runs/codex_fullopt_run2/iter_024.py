"""Tightly seeded genetic surplus-grid search with AL pruning.

HYPOTHESIS: The first GA was too diffuse; seeding the genetic_algorithm with a
tighter dense-lattice spread should preserve useful spacing traits while
crossover and mutation explore offsets, shear, and rotation.
AXIS: genetic_algorithm crossover and mutation population search with tight
dense-lattice seeding plus augmented-Lagrangian NAdam refinement.
