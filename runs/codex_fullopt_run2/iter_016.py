"""Surplus-grid Bayesian search with augmented-Lagrangian NAdam pruning.
...
short BO-style parameter search finds a stronger wind-aligned grid basin.
AXIS: bayesian_optimization grid search plus constraint_augmented_lagrangian
and nesterov_momentum Adam refinement with surplus pruning.
