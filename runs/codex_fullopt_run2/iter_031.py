"""CMA surplus-grid search with wider final polish ensemble.

HYPOTHESIS: The incumbent CMA basin is strong, but choosing only the top two
pre-polish pruned layouts may discard candidates whose constraints respond
better to the final augmented-Lagrangian NAdam phase.
AXIS: cmaes covariance-adaptation search over surplus-grid parameters plus
contribution pruning and a wider final augmented-Lagrangian polish ensemble.
