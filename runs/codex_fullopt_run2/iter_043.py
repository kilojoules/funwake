"""Exact-size BO grid with affine micro-search repair ensemble.
...
stronger basin. The final projection ensemble is still only a feasibility
repair, so a small affine search around the polished layout may recover AEP by
shifting global wakes before repair.

AXIS: BO-tuned exact-size grid plus staged AL-NAdam halving, with a final
learning-rate ensemble, affine transform micro-search, projection ensemble, and
no surplus-pruning or TopFarm warm-start polish.
