"""Exact-size BO grid with projected AEP-gradient finish.
...
stronger basin. The last coordinate-nudge finish improved only by discrete
single-turbine moves; a short projected AEP-gradient polish can exploit
coupled turbine motion while preserving strict feasibility.
...
on the true AEP gradient instead of coordinate pattern search.
