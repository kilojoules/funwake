"""Exact-size BO grid with weighted wake-pair decoupling finish.
...
escape should target the specific turbine pairs that are nearly aligned in the
weighted wind frame, because moving only the weaker member sideways can reduce
the dominant wake interactions without disturbing whole rows.
