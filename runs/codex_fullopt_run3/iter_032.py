"""Exact-size BO grid with wind-frame lane-phase finish.
...
weak-void reinsert again tied the 5584.45 GWh plateau. A different escape
should test a coherent wind-frame topology warp instead of sparse turbine
replacement: phase-shift whole crosswind lanes with sinusoidal streamwise and
crosswind offsets, project back to feasibility, and keep only strict AEP
improvements.
...
nesterov_momentum projected finish followed by wind-frame lane-phase topology
warps and sector/contact cleanup.

LESSON: Scored 5584.45 GWh feasible in 136.3s; lane-phase topology warps
generalized feasibly in 139.4s but did not improve beyond the 5584.45 plateau.
"""
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    lane_x, lane_y = lane_phase_finish(nesterov_x, nesterov_y)
    lane2_x, lane2_y = lane_phase_finish(lane_x, lane_y)
    sector_x, sector_y = sector_contact_finish(lane2_x, lane2_y)
