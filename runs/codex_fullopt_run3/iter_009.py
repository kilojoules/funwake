"""Sparse trust-constr polish from Latin-hypercube lattice starts.

HYPOTHESIS: Earlier high scores came from strong lattice basins, but penalty
polish either tolerated tiny constraint violations or spent effort on penalty
weight schedules. A sparse trust-constr interior-point solve can use exact
boundary half-planes and all pairwise spacing constraints from a feasible
Latin-hypercube lattice screen.
