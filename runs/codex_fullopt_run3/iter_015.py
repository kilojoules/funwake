"""BO grid with additive wind-sector k-means starts.

HYPOTHESIS: SHGO and PSO both degraded the basin when they displaced BO
lattice starts. An init_kmeans / k-means initializer can instead add a
different wind-sector-aware centroid layout to the same batch, giving the
AL-NAdam halving stages a non-lattice candidate while preserving the known
strong BO starts.

AXIS: BO-tuned exact-size grid plus additive init_kmeans centroid layouts,
