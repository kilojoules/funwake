"""Iter 221: Higher LR (5x) + dual bumps at t=0.5 and t=0.8.

Two escape opportunities instead of one. Stronger alpha to compensate
for higher LR. Same proven warmup+cosine backbone.
"""
