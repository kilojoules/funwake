"""Iter 305: Plateau 25% + double bump (0.55, 0.78) + less alpha_extra.

Same as iter_298 but reducing alpha_extra from 3.0 to 2.0 — less
constraint pressure → maybe higher AEP while still feasible.
"""
