"""Iter 056: Power-law LR decay instead of 1/(1+kt).

lr = lr_init * (1 - decay_t)^3 + lr_min
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    lr_pow = (lr_init - lr_min) * (1.0 - decay_t) ** 3 + lr_min
    lr = jnp.where(in_const, lr_init, lr_pow)
