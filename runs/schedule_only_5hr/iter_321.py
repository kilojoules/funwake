"""Iter 321: iter_317 with alpha_extra = 4.0 (instead of 3.0).

Slightly more aggressive background alpha ramp to ensure feasibility
more reliably while keeping the burst structure.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    fb1 = 15.0 * alpha0 * jnp.exp(-0.5 * ((t - 0.85) / 0.02) ** 2)
    fb2 = 25.0 * alpha0 * jnp.exp(-0.5 * ((t - 0.93) / 0.015) ** 2)
