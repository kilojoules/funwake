"""Iter 320: iter_317 with stronger first exploration bump (0.30x at 0.55).

More exploration energy mid-optimization.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    bump1 = 0.30 * lr_init * jnp.exp(-0.5 * ((t - 0.55) / 0.04) ** 2)
