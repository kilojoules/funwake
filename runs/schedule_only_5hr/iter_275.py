"""Iter 275: Asymmetric cosine t^0.8 (NaN fix) — faster decay.

Power < 1 decays LR faster. Less exploration but faster convergence
to feasible region. With 5x alpha + 3x quad.
"""
