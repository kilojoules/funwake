"""Iter 207: iter_179 clone with beta1=0.2 (less momentum).

Testing sensitivity to beta1. Lower momentum should make the optimizer
more responsive to local gradient changes — potentially better for
