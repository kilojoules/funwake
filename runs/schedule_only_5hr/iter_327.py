"""Iter 327: iter_322 with feas burst alpha weights 18/28 (slightly higher).

Testing if stronger alpha at feas bursts helps push into better
feasibility without losing much AEP.
"""
