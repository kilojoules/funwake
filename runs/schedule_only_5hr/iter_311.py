"""Iter 311: Plateau + bumps with decreasing beta1 (0.5 → 0.15).

High momentum early for fast exploration, low momentum late for precision.
Beta2 constant at 0.5.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    # Linearly decay beta1 from 0.5 to 0.15
    beta1 = 0.5 - 0.35 * t
    beta2 = 0.5
