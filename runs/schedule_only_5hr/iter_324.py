"""Iter 324: iter_322 base with bumps shifted to 0.50 and 0.73.

Earlier exploration bumps + feas bursts at 0.84/0.92.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    bump1 = 0.25 * lr_init * jnp.exp(-0.5 * ((t - 0.50) / 0.04) ** 2)
    bump2 = 0.2 * lr_init * jnp.exp(-0.5 * ((t - 0.73) / 0.03) ** 2)
