"""Iter 329: iter_327 + feas burst alpha to 20/32 (even stronger).

Pushing feasibility enforcement even higher at bursts.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    fb1 = 20.0 * alpha0 * jnp.exp(-0.5 * ((t - 0.84) / 0.02) ** 2)
    fb2 = 32.0 * alpha0 * jnp.exp(-0.5 * ((t - 0.92) / 0.015) ** 2)
