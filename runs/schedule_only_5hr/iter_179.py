"""Iter 179: Linear warmup (5%) + cosine decay + bump.

Brief warmup lets Adam build gradient estimates before big steps.
Same alpha/beta as best-performing iter_166.
"""
