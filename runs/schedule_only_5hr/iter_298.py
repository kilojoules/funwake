"""Iter 298: Plateau (25%) + steep cosine + double bump.

Constant high LR for first 25% (maximum exploration), then steep cosine.
Two bumps at 0.55 and 0.75 to escape local minima twice.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    # Constant for first 25%, cosine decay for rest
    plateau_end = 0.25
