"""Iter 265: Asymmetric cosine t^0.7 + moderate alpha (7x + 4x quadratic from 0.35).

Slightly less aggressive alpha than 264 to keep more AEP upside.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    # 7x coupling + 4x quadratic from t=0.35
    alpha_base = 7.0 * alpha0 * lr_init / jnp.maximum(lr, 1e-10)
    late = jnp.maximum(t - 0.35, 0.0) / 0.65
