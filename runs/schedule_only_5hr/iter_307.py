"""Iter 307: Plateau 25% + double bump + asymmetric cosine (t^0.8).

Combine the plateau+bump pattern from iter_298 with the slower
initial decay (asymmetric cosine) from iter_262.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    # Asymmetric: t^0.8 keeps LR higher longer after plateau
