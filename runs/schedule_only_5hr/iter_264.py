"""Iter 264: Asymmetric cosine t^0.7 + stronger alpha (8x + 5x quadratic).

iter_262 hit 5600 but was infeasible. Boost alpha to enforce constraints.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    # Stronger alpha: 8x coupling + 5x quadratic from t=0.4
    alpha_base = 8.0 * alpha0 * lr_init / jnp.maximum(lr, 1e-10)
