"""Iter 306: Plateau 25% + double bump + alpha_base=3.0 (less base coupling).

Reducing alpha_base multiplier from 5.0 to 3.0 while keeping
alpha_extra at 3.0. Less constraint early → more exploration.
"""
