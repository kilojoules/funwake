"""Iter 259: 5x lr0 (250) with proven cosine+bump formula.

Higher initial LR means bigger exploration steps. Everything else
matches the best-performing iter_179 structure.
"""
