"""Iter 277: Proven formula + double bump at t=0.45 and t=0.7.

Hypothesis: an extra escape opportunity at 45% could find better basin
before the main bump at 70%.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    # Two bumps: early exploration + late refinement escape
