"""Iter 261: Strong bump (0.5x) at t=0.65 for earlier escape.

Hypothesis: a bigger LR spike earlier gives more room to explore
before alpha gets too high.
"""
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    # Stronger bump, earlier position
