"""Standard Adam memory on the strongest schedule backbone.

HYPOTHESIS: The best previous schedule may be limited by very short Adam
memory; standard Adam betas can smooth wake-gradient spikes and produce a
cleaner late layout while retaining the same LR/alpha trajectory.
AXIS: adam_standard applied to the best feasible noisy cooling schedule.
LESSON: pending
"""
import jax
