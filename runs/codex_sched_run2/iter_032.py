"""Lower mid-run linear alpha with late-only repair compensation.

HYPOTHESIS: Reducing the linear alpha multiplier below the prior best can
preserve more objective-driven wake movement, while a stronger late quadratic
repair term keeps the final layout feasible.
AXIS: alpha_linear_ramp coefficient sweep with late repair compensation.
LESSON: pending
"""
import jax
