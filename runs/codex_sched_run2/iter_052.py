"""Slightly stronger low-momentum LR perturbation.

HYPOTHESIS: The current best may still be under-exploring the mid-run wake
basin; a small increase in bounded LR perturbation can test that without
changing the proven alpha repair envelope.
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    lr = lr_base + lr_base * (0.085 * noise_gate) * lr_noise
