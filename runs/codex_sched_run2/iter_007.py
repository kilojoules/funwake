"""Polynomial one-cycle bell on seed decay.

HYPOTHESIS: A smooth compact polynomial pulse can approximate one controlled
early exploration move without using Gaussian bumps, restarts, or repeated LR
shakes that previously hurt train AEP.
AXIS: lr_one_cycle with a polynomial_decay-style bell, inverse alpha coupling,
and end-only feasibility repair.
LESSON: pending
"""
