"""Slightly stronger linear alpha repair on the best schedule backbone.

HYPOTHESIS: The best previous result benefited from a mild linear alpha ramp;
a small increase may improve final feasibility pressure without materially
disturbing the mid-course noisy wake-basin search.
AXIS: alpha_linear_ramp coefficient sweep on the best feasible backbone.
LESSON: pending
"""
import jax
