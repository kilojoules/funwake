"""TopFarm-low momentum with staged feasibility repair.

HYPOTHESIS: Explicit TopFarm-style low Adam smoothing can keep wake-basin
movement responsive while a monotone staged alpha transition avoids the
seed-sensitive LR noise used in the recent attempts.
AXIS: adam_topfarm_low with deterministic exponential LR and staged alpha.
LESSON: pending
"""
