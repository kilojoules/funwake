"""Noise-seed sweep on the proven exponential repair envelope.

HYPOTHESIS: The best-known schedule is basin-sensitive; a fresh deterministic
LR-noise seed may discover a slightly better feasible wake basin while keeping
the alpha repair path unchanged.
AXIS: lr_noise_injection seed sweep on noisy exponential backbone.
LESSON: pending
"""
import jax
