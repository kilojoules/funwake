"""Slightly softer low-momentum LR perturbation.

HYPOTHESIS: The best low-momentum noisy schedule may be close to the boundary
of useful stochastic displacement; slightly reducing noise amplitude could
keep the selected basin while reducing late constraint repair load.
AXIS: adam_topfarm_low with lr_noise_injection amplitude sweep.
LESSON: pending
"""
import jax
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    lr = lr_base + lr_base * (0.075 * noise_gate) * lr_noise
