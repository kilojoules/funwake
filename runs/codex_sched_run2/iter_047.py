"""Alternate LR-noise seed on the best noisy alpha schedule.

HYPOTHESIS: The best schedule may be sensitive to the deterministic LR-noise
sequence; changing only the noise seed can sample a nearby wake basin while
preserving the proven alpha and LR envelope.
