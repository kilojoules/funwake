"""HYPOTHESIS: TopFarm-low Adam moments may react faster to constraint
gradients than the medium-memory best schedule, while the validated
alpha0-gated LR/penalty path supplies the same basin selection.
AXIS: adam_topfarm_low on restored alpha0-gated dual-window schedule.
