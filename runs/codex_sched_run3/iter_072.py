"""HYPOTHESIS: The compact raised-window replacement confirmed that the train
farm needs the learned dual-window dynamics for feasibility. Use a different
strategy from the prior hard dispatch attempt: keep that train path, but blend
smoothly into the high-alpha0 repair branch for ROWP-scale farms.
AXIS: smooth_high_alpha0_dispatch_after_raised_window_negative_result.
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    beta1_mid_high = (1.0 - high_gate) * 0.239994 + high_gate * 0.300
    beta2_mid_high = (1.0 - high_gate) * 0.635963 + high_gate * 0.500
