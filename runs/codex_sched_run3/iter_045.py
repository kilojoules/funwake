"""HYPOTHESIS: A very shallow alpha dip may capture anti-phase relaxation
without materially changing the validated repair balance of the best
alpha0-gated dual-window schedule.
AXIS: small alpha_anti_phase_dip on alpha0-gated dual-window schedule.
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    alpha_real = alpha_real * (1.0 - 0.032 * jnp.exp(-0.5 * ((t - 0.585) / 0.065) ** 2))
