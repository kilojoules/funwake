"""HYPOTHESIS: The strongest known train/ROWP schedule uses alpha0 as a
problem-scale signal: preserve the validated dual-window warmup/cosine path on
real-farm scales, but route low-alpha0 stress cases through a tighter terminal
repair path.
