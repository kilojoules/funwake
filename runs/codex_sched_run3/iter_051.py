"""HYPOTHESIS: The unexplored constant-LR, standard-Adam, two-phase, and
TopFarm-low probes did not improve the run; restore the validated alpha0-gated
dual-window schedule as the best robust optimizer for final validation.
AXIS: restored_alpha0_gated_dual_window_after_unexplored_family_checks.
