"""HYPOTHESIS: The best LR/alpha envelope may not need medium Adam memory;
TopFarm-low betas could react faster to active constraint gradients during
late repair while preserving the known basin path.
AXIS: adam_topfarm_low on alpha0-gated dual-window schedule.
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    alpha_repair = alpha_repair + 72.00 * alpha0 * tail ** 2
