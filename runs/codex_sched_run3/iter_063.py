"""HYPOTHESIS: Direct train-branch edits continue to lose AEP, so use alpha0
only as a problem-scale router. The train-scale band keeps the exact validated
dual-window trajectory, while clearly low/high alpha0 cases use repair paths.
AXIS: exact_train_band_with_hard_alpha0_scale_routing.
