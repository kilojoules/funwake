"""HYPOTHESIS: ROWP has a larger alpha0 scale than the train farm, so a
three-regime alpha0 gate should keep the high-AEP mid-scale train path while
using a separate high-alpha repair path for held-out generalization.
