"""HYPOTHESIS: Weakening the real-scale penalty worsened AEP, so the useful
effect may be earlier constraint-shaped basin selection; a slight normal-scale
penalty increase may improve that trajectory without changing low-scale repair.
AXIS: alpha0_gated_dual_window_with_firmer_real_scale_penalty.
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    alpha_real = 3.15 * alpha0 * real_init / lr_real
    alpha_real = alpha_real + 18.4 * alpha0 * late ** 2
