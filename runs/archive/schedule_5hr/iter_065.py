"""3-stage topfarm with aggressive exploration and high LR.

Changes from iter_064 (5557.15):
- Higher exploration LR (150 vs 100) for bigger steps
- Lower spacing weight (0.1 vs 0.3) for maximal exploration freedom
- Longer exploration const LR phase
- Dropped fine-tune stage (marginal gain), use time for more exploration
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 2: Very aggressive exploration
    s2 = SGDSettings(
        learning_rate=150.0,
        max_iter=4000,
        ...
        tol=1e-6,
        beta1=0.1, beta2=0.2,
        spacing_weight=0.1, boundary_weight=5.0,
