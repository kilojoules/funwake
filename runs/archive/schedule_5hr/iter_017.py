"""Three-stage optimize(): feasibility → explore AEP → re-enforce.

Extends iter_016's feasibility-first approach with a third refinement
stage that re-tightens constraints after AEP exploration.
"""
import jax
