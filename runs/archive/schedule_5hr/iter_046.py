"""4-stage topfarm pipeline: feasibility → aggressive explore → gentle enforce → strong enforce.

Previous 3-stage approaches jump from sw=0.5 to sw=300, destroying AEP.
This adds an intermediate enforcement stage (sw=30) to let turbines
adjust gradually before final strong enforcement. Also uses higher
beta1=0.3 for more momentum in exploration phase.
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 2: Aggressive AEP exploration (very low constraint penalty)
    ...
    # Stage 3: Gentle enforcement (intermediate)
    ...
    # Stage 4: Strong enforcement (final)
