"""Exact reproduction of iter_047's proven approach (5558.15 GWh).

Matching iter_047's schedule values exactly to verify reproducibility,
then will tune from this baseline.
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # --- Wind-aware grid initialization (matching iter_047) ---
    ...
    # === CUSTOM ADAM (matching iter_047 exactly) ===
    ...
    # === Topfarm polish (matching iter_047) ===
