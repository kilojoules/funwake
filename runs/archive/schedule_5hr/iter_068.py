"""3-stage topfarm: push exploration further.

iter_067 got 5566.35 (+25.63) with LR=200, sw=0.1, bw=20, const_lr=3000.
Try even more exploration: higher LR (250), more const_lr iters (3500),
and a slightly higher max_iter.
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 2: Even more aggressive exploration
    s2 = SGDSettings(
        learning_rate=250.0,
        max_iter=5000,
        additional_constant_lr_iterations=3500,
        tol=1e-6,
        beta1=0.1, beta2=0.2,
