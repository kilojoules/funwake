"""Refined 2+1 stage: lower sw, lighter enforcement.

iter_089 got 5561.53. Changes:
- Stage 2: sw=5 (vs 8) for more exploration, bw=40 (vs 35)
- Stage 3: lighter enforcement (sw=200, max_iter=1500) to preserve AEP
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    s2 = SGDSettings(
        ...
        tol=1e-6, beta1=0.1, beta2=0.2,
        spacing_weight=5.0, boundary_weight=40.0,
        ks_rho=80.0, gamma_min_factor=0.01,
    )

    # Stage 3: Lighter enforcement polish
    s3 = SGDSettings(
        learning_rate=50.0,
        max_iter=1500, additional_constant_lr_iterations=750,
        tol=1e-6, beta1=0.1, beta2=0.2,
        spacing_weight=200.0, boundary_weight=200.0,
        ks_rho=120.0, gamma_min_factor=0.01,
    )
