"""3-stage topfarm with HIGH momentum (ADAM-style).

All previous topfarm approaches use beta1=0.1, beta2=0.2 (SGD-like).
Custom ADAM approaches use beta1=0.9, beta2=0.999 (true ADAM).

This combines the best of both:
- topfarm_sgd_solve handles alpha ramping automatically
- ADAM-style high momentum enables faster exploration
- 3-stage structure from iter_067 (sw=0.1 exploration)

Key differences from iter_067:
- beta1=0.9, beta2=0.999 (vs 0.1, 0.2)
- Slightly different LR to account for momentum behavior
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 1: Feasibility push with high momentum
    s1 = SGDSettings(
        learning_rate=150.0,
        max_iter=1500,
    ...
    # Stage 2: Aggressive exploration with ADAM momentum
    s2 = SGDSettings(
        learning_rate=150.0,
        max_iter=4000,
    ...
    s3 = SGDSettings(
        ...
        tol=1e-6,
        beta1=0.1, beta2=0.2,  # low momentum for stable convergence
