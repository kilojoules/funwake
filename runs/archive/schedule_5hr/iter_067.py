"""3-stage topfarm: tuned exploration LR and duration.

Building on iter_065 sweet spot (sw=0.1, 5557.59).
Changes:
- Exploration LR=200 (bigger steps for more coverage)
- More exploration const_lr iters (3000 vs 2500) for longer plateau
- Slightly higher bw=20 to keep turbines in boundary during exploration
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 2: Aggressive exploration, higher LR
    s2 = SGDSettings(
        learning_rate=200.0,
        max_iter=4000,
