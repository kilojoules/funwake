"""Optimized double basin-hop: longer hops, more aggressive exploration.

iter_055 got 5557.79 with double hop. This version:
- Longer hop phases (1500 iters each instead of 1000-1200)
- Higher LR in hops (250, 350) for stronger basin escape
- Final enforcement with more iters for robust feasibility
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    s1 = SGDSettings(
        learning_rate=120.0, max_iter=1800,
    ...
    # Stage 5: Hop 2 - even stronger escape
    s5 = SGDSettings(
        learning_rate=350.0, max_iter=1500,
        additional_constant_lr_iterations=750,
        tol=1e-6, beta1=0.1, beta2=0.2,
        spacing_weight=0.01, boundary_weight=2.0,
        ks_rho=30.0, gamma_min_factor=0.01,
    ...
    # Stage 6: Final robust enforcement
    s6 = SGDSettings(
