"""3-stage topfarm: feasibility → aggressive exploration → enforcement.

This approach consistently scores 5555-5558 in previous attempts.
Stage 1: High penalty to push into feasible region
Stage 2: Very low sw/bw for pure AEP exploration
Stage 3: High penalty to restore feasibility
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 2: Aggressive AEP exploration (very low penalties)
    s2 = SGDSettings(
        learning_rate=100.0,
        max_iter=3000,
