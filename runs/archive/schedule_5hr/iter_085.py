"""Tuned 3-stage topfarm: more aggressive exploration.

Building on iter_068 (5559-5566 depending on run). Changes:
- Stage 1 shorter (1000+500 → save time for exploration)
- Stage 2: higher LR (300), longer constant phase (4000),
  even lower spacing weight (0.05), keep boundary at 20
- Stage 3: same strong enforcement but slightly more iterations
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 2: Aggressive exploration — higher LR, lower spacing penalty
    s2 = SGDSettings(
        learning_rate=300.0,
        max_iter=5500, additional_constant_lr_iterations=4000,
        tol=1e-6, beta1=0.1, beta2=0.2,
        spacing_weight=0.05, boundary_weight=20.0,
    ...
    s3 = SGDSettings(
        learning_rate=50.0,
        max_iter=3000, additional_constant_lr_iterations=1500,
        tol=1e-6, beta1=0.1, beta2=0.2,
