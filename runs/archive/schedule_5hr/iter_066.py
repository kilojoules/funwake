"""3-stage topfarm: maximal exploration freedom.

Changes from iter_065 (5557.59):
- Exploration sw=0.05 (near zero penalty) for max AEP freedom
- Keep bw=15 (don't fly outside boundary, wasteful)
- More exploration iters (5000+2500)
- Stronger enforcement (sw=400, bw=400) to recover
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 2: Maximum exploration freedom
    s2 = SGDSettings(
        learning_rate=150.0,
        max_iter=5000,
        additional_constant_lr_iterations=2500,
        tol=1e-6,
        beta1=0.1, beta2=0.2,
    ...
    # Stage 3: Very strong enforcement
    s3 = SGDSettings(
        learning_rate=50.0,
        max_iter=2500,
        ...
        tol=1e-6,
        beta1=0.1, beta2=0.2,
        spacing_weight=400.0, boundary_weight=400.0,
