"""Two-stage optimize(): explore with relaxed constraints, then enforce.

Different strategy from all schedule_fn attempts. Uses topfarm_sgd_solve
directly with two stages:
  Stage 1: High LR, relaxed constraints - find good AEP region
  Stage 2: Lower LR, strict constraints - enforce feasibility + refine
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 1: Explore AEP landscape with relaxed constraints
    ...
    # Stage 2: Enforce constraints and refine AEP
    settings_s2 = SGDSettings(
        learning_rate=80.0,
        max_iter=3500,
        additional_constant_lr_iterations=1750,
        tol=1e-6,
        beta1=0.1,
        beta2=0.2,
