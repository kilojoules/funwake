"""Three-stage: gentler stage 3 enforcement to preserve more AEP.

Exact iter_017 base, but stage 3 uses lower ks_rho (100 vs 150) and
lower constraint weights (150 vs 300) for less aggressive enforcement.
"""
import jax
