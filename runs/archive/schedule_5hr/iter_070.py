"""Variation on iter_067 (5566.35): longer constant LR plateau.

const_lr=3500 (up from 3000). More time at full learning rate
before decay starts. Also max_iter=4500 for more total exploration.
"""
import jax
