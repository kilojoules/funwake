"""Four-stage: feasibility → free explore → moderate → gentle enforce.

Gradual constraint tightening instead of the sharp jump in 3-stage.
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 3: Moderate constraint tightening
    ...
    # Stage 4: Final gentle enforcement
