"""Three-stage: stronger stage 1, relaxed stage 2 with higher LR.

Base is iter_022 (best). Try stronger initial feasibility + higher LR
in stage 2 for more aggressive AEP exploration.
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Same gentle stage 3 as iter_022
