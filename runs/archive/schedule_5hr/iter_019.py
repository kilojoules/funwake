"""Three-stage with higher stage 2 LR and longer AEP phase.

Variant of iter_017's winning approach. Stage 2 uses higher LR (150)
and slightly more iterations for more aggressive AEP exploration.
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 1: Feasibility push (same as iter_017)
    ...
    # Stage 2: More aggressive AEP exploration
    ...
    # Stage 3: Re-enforce (same as iter_017)
