"""Variation on iter_067 (5566.35): slightly higher sw=0.2 in exploration.

Testing if a tiny bit more spacing enforcement during exploration
prevents turbines from collapsing, giving enforcement a better
starting point.
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 2: Exploration with sw=0.2
    s2 = SGDSettings(
        learning_rate=200.0,
        max_iter=4000,
        ...
        tol=1e-6,
        beta1=0.1, beta2=0.2,
        spacing_weight=0.2, boundary_weight=20.0,
