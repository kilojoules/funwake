"""Rect grid + aggressive exploration (sw=0.5, bw=10) + strong enforcement.

iter_044 (hex grid + sw=0.5) got 5556.95 (+16.24). Try the same
aggressive exploration with rectangular grid since the all-time best
feasible (5557.21) used rectangular grid.
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 2: Aggressive exploration (sw=0.5 instead of 2.0)
    ...
    # --- Rectangular wind-aware grid initialization ---
