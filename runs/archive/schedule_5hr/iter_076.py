"""Exact reproduction of iter_058 (5566.35) to verify baseline.

Copying every parameter value exactly from iter_058.
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # === CUSTOM ADAM with momentum warm restarts (EXACT iter_058) ===
