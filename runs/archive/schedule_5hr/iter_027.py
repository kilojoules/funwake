"""Custom vanilla SGD with jax.lax.fori_loop and 3-phase penalty scheduling.

Based on v4 best (+59.3 GWh) which used vanilla SGD + fori_loop.
Key change: 3-phase penalty schedule (feasibility -> explore -> enforce)
instead of 2-phase.
"""
import jax
