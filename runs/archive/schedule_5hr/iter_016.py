"""Two-stage optimize(): feasibility-first, then AEP refinement.

Opposite ordering from iter_015: push hard on constraints first to get
a clean feasible starting point, then optimize AEP with relaxed penalties.
Inspired by v4 attempt 23 (5553.1 GWh).
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 1: Aggressive feasibility push
    ...
    # Stage 2: AEP maximization from feasible start
