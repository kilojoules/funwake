"""Three-stage with near-zero stage 2 constraints + higher stage 1 LR.

Push iter_017 further: stage 2 has nearly zero constraint weights
to maximize AEP exploration freedom, and stage 3 handles all
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Stage 1: Strong feasibility push
    ...
    # Stage 2: Nearly unconstrained AEP optimization
