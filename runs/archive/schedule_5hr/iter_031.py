"""Vanilla SGD + fori_loop replicating v4 best, with LR warmup for stability.

2-phase penalty, 12000 iterations. LR warmup over first 200 iterations
to prevent gradient explosion on difficult geometries.
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    def sgd_step(i, state):
        ...
        # LR with warmup then decay
        warmup_factor = jnp.minimum(1.0, (i + 1.0) / warmup_iters)
        lr = initial_lr * warmup_factor * (lr_decay_rate ** i)
