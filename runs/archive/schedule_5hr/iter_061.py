"""Custom ADAM closely matching iter_047's proven pattern + schedule tuning.

iter_047 got 5558.15. Matching its structure exactly:
- grad_fn precomputed once, alpha passed as argument
- Constant high momentum (0.9/0.999)
- Step clipping to min_spacing
- Cosine penalty schedule
- Topfarm polish at end

Differences from iter_047:
- Exploration phase alpha even lower (0.3 vs 1)
- Slightly longer exploration (5500 iters vs 5000)
- Higher final enforcement (500 vs 400)
"""
import jax
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    # Precompute grad_fn once (matching iter_047 pattern)
