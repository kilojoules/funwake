...
def schedule_fn(step, total_steps, D, min_spacing, n_turbines, gamma_min, alpha0):
    ...
    lr_body = lr_peak * (0.66 + 0.34 * warm_s) * (1.0 - 0.954 * cool_s)
    ...
    delay = jnp.clip((t - 0.45) / 0.295, 0.0, 1.0)
    ...
    alpha_base = alpha0 * (1.045 + 3.00 * delay_s)
    ...
    beta2 = 0.138 + 0.215 * delay_s + 0.125 * terminal_s
