...
def schedule_fn(step, total_steps, D, min_spacing, n_turbines, gamma_min, alpha0):
    ...
    cool = jnp.clip((t - 0.515) / 0.405, 0.0, 1.0)
    cool_s = cool * cool * (3.0 - 2.0 * cool)

    lr_body = lr_peak * (0.650 + 0.350 * warm_s) * (1.0 - 0.958 * cool_s)
    ...
    delay = jnp.clip((t - 0.465) / 0.285, 0.0, 1.0)
    ...
    alpha_base = alpha0 * (1.030 + 3.10 * delay_s)
    ...
    beta2 = 0.132 + 0.230 * delay_s + 0.126 * terminal_s
