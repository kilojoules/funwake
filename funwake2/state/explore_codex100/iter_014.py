...
def schedule_fn(step, total_steps, D, min_spacing, n_turbines, gamma_min, alpha0):
    ...
    lr_body = lr_peak * (0.665 + 0.335 * warm_s) * (1.0 - 0.953 * cool_s)
    lr_body = jnp.maximum(lr_body, 2.90 * gamma_min)
    ...
    beta1 = 0.215 - 0.122 * delay_s - 0.055 * terminal_s
    beta2 = 0.138 + 0.212 * delay_s + 0.118 * terminal_s
