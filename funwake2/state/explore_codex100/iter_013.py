...
def schedule_fn(step, total_steps, D, min_spacing, n_turbines, gamma_min, alpha0):
    ...
    alpha_base = alpha0 * (1.035 + 3.08 * delay_s)
    ...
    beta2 = 0.134 + 0.224 * delay_s + 0.124 * terminal_s
