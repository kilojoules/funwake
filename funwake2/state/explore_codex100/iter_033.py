...
def schedule_fn(step, total_steps, D, min_spacing, n_turbines, gamma_min, alpha0):
    ...
    lr_body = lr_peak * (0.665 + 0.335 * warm_s) * (1.0 - 0.955 * cool_s)
    ...
    delay = jnp.clip((t - 0.44) / 0.295, 0.0, 1.0)
    ...
    alpha_base = alpha0 * (1.035 + 3.18 * delay_s)
    ...
    beta1 = 0.215 - 0.123 * delay_s - 0.055 * terminal_s
    beta2 = 0.138 + 0.212 * delay_s + 0.122 * terminal_s
