...
def schedule_fn(step, total_steps, D, min_spacing, n_turbines, gamma_min, alpha0):
    ...
    hold = 1.0 - jnp.clip((t - 0.40) / 0.60, 0.0, 1.0)
    ...
    alpha_late = alpha0 * D / jnp.maximum(2.4 * gamma_min, 1e-30)

    alpha_base = alpha0 * (1.08 + 2.75 * delay_s)
    ...
    beta1 = 0.19 - 0.11 * delay_s - 0.04 * terminal_s
