...
def schedule_fn(step, total_steps, D, min_spacing, n_turbines, gamma_min, alpha0):
    ...
    alpha_base = alpha0 * (1.055 + 3.18 * delay_s)
    ...
    beta1 = 0.212 - 0.123 * delay_s - 0.056 * terminal_s
    beta2 = 0.138 + 0.218 * delay_s + 0.124 * terminal_s
