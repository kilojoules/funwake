...
while :; do
  ...
  pixi run python funwake2/run_portfolio_explore.py --engine codex --tag "$TAG" --resume \
      --iters "$ITERS" --seeds 0 1 2 --steps 8000 --eval-backend gbar --feas-slack 5 \
      --cells dei_n30_rosedei dei_n30_roseuniform dei_n40_roseomnidir dei_n40_roserowp dei_n50_rosedei dei_n50_roseuniform dei_n60_roserowp dei_n60_roseomnidir dei_n70_rosedei dei_n80_roseomnidir dei_n80_roseuniform parque_n10_omnidir parque_n20 parque_n30_uniform dei_n100 dei_n120_rosedei
