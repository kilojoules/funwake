"""Mid-course LR noise with mild linear alpha repair.

HYPOTHESIS: Attempt 22 was a boundary-only near miss; keeping its high-AEP
trajectory while adding a mild linear alpha ramp may recover boundary
feasibility with less objective loss than reshaping the noise window.
AXIS: alpha_linear_ramp layered onto lr_noise_injection.
LESSON: pending
"""
import jax
