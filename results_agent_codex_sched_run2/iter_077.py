"""Higher final LR floor on the incumbent noisy repair envelope.

HYPOTHESIS: The best scored schedule improved when the final floor rose from
the original value. A slightly higher floor may keep enough late motion to
escape marginal wake losses while retaining the same alpha repair envelope
that passed both train and held-out feasibility.
AXIS: lr_exponential_decay final floor sweep on proven noisy envelope.
LESSON: pending
"""
import jax
