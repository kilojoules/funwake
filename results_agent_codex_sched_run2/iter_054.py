"""Scheduled Adam memory on the best noisy exponential backbone.

HYPOTHESIS: The current best noisy schedule benefits from sign-like Adam during
basin selection, but late constraint repair may overshoot with the same very
short memory. A mild late increase in beta1/beta2 should smooth repair without
changing the high-AEP LR trajectory.
AXIS: dynamic Adam betas layered onto the best lr_noise_injection schedule.
LESSON: pending
"""
import jax
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    beta1 = 0.06 + 0.16 * late
    beta2 = 0.16 + 0.24 * late
