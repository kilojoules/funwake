"""Slightly slower cooling on the best repair schedule.

HYPOTHESIS: The best noisy schedule may cool a little too quickly before the
late repair phase; a slightly slower exponential curvature can retain useful
layout movement while the existing alpha ramp preserves feasibility.
AXIS: lr_exponential_decay curvature sweep on the best feasible backbone.
LESSON: pending
"""
import jax
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    alpha = alpha * (1.0 + 7.0 * late + 54.0 * late * late)
