"""Exponential cooling with mid-course stochastic LR noise.

HYPOTHESIS: Restricting LR noise to the middle of the run can perturb wake
basin selection after the coarse layout forms while leaving early expansion
and late constraint repair smooth.
AXIS: lr_noise_injection with smooth penalty coupled to the unperturbed
exponential backbone.
LESSON: pending
"""
import jax
