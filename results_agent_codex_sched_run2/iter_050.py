"""TopFarm-low momentum with controlled mid-run LR perturbation.

HYPOTHESIS: The deterministic low-momentum branch under-repairs held-out
boundaries; restoring a bounded mid-run LR perturbation may recover the better
wake basin while keeping the explicit TopFarm-low Adam pair.
AXIS: adam_topfarm_low plus lr_noise_injection on the proven alpha repair.
LESSON: pending
"""
import jax
