"""More responsive Adam moments on the best basin-entry envelope.

HYPOTHESIS: Higher Adam memory smoothed away useful displacement in prior
attempts. Keeping the validated noisy LR and penalty repair but lowering both
moment decays slightly may let final wake-improving gradients move turbines
without changing feasibility pressure.
AXIS: low-beta Adam responsiveness on incumbent noisy LR/alpha envelope.
LESSON: pending
"""
import jax
