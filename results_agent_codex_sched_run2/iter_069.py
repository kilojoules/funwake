"""Slightly softer final LR floor on the best noisy backbone.

HYPOTHESIS: The incumbent may be mildly over-polished by the very low final
LR; a small floor increase keeps late movement alive while retaining the same
alpha repair schedule that made the noisy basin feasible.
AXIS: lr_exponential_decay floor sweep on proven noisy repair envelope.
LESSON: pending
"""
import jax
