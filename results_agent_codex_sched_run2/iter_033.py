"""Slightly larger mid-course LR perturbation on the best repair schedule.

HYPOTHESIS: The prior best's alpha repair can tolerate a little more mid-run
LR perturbation, potentially crossing to a better wake basin before the same
late feasibility mechanism activates.
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    lr = lr_base + lr_base * (0.10 * noise_gate) * lr_noise
