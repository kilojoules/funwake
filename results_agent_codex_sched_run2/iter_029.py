"""Quadratic alpha repair on the strongest schedule backbone.

HYPOTHESIS: A quadratic alpha multiplier can stay closer to the high-AEP
near-miss trajectory through the middle of the run, then add more penalty than
the prior linear ramp only when boundary repair matters most.
AXIS: alpha_quadratic_ramp layered onto the high-scoring noisy cooling
schedule with short-memory Adam.
LESSON: pending
"""
import jax
