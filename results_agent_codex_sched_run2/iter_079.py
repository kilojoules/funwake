"""Faster exponential cooling on the incumbent noisy envelope.

HYPOTHESIS: The current schedule may be carrying too much late movement after
the basin is found. A slightly faster exponential decay tests whether earlier
polishing improves AEP while the inverse alpha coupling increases repair
pressure in step with the lower learning rate.
...
def schedule_fn(step, total_steps, lr0, alpha0):
    ...
    lr_base = jnp.maximum(lr_start * jnp.exp(-8.25 * t * t), lr_floor)
