...
#BSUB -W 24:00
#BSUB -u /dev/null
#BSUB -o /zhome/5c/f/180689/clusters_logs/highn.%J.%I.out
#BSUB -e /zhome/5c/f/180689/clusters_logs/highn.%J.%I.err

# High-N (200, 300) sweep — 16 cells × {7 ηT baseline + claude + gemini} × 3 seeds = 27 runs/cell
set -euo pipefail
...
echo "=== highn task $LSB_JOBINDEX / 16, cell_idx=$CELL_IDX ==="
hostname; date
