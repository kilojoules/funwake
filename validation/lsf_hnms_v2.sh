...
PYTHONPATH=playground/pixwake/src:playground pixi run python tools/run_matrix_ms_highn.py --cell-idx $((LSB_JOBINDEX-1)) --K 50 --out $HOME/clusters_results/funwake_matrix_ms_highn_v2/cell$((LSB_JOBINDEX-1)).json
