...
(both DEI single-polygon roses, the DEI omnidirectional and unidirectional cells, and the
two Parque cells; the high-count DEI-120 cell is an elite-tier probe, not part of this
portfolio) --- the elite that maximizes the farm-balanced training fitness of
...
paired seeds per cell, both schedules feasible on every seed; the high-count DEI-120 cell
of \cref{tab:cells} is an elite-tier probe and is not re-scored here). Gains concentrate on the offshore single-polygon
