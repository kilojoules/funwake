"""Affine recovery with post-pair constrained fine polish.

HYPOTHESIS: The active-pair release can open a slightly different feasible
neighborhood. A final very small constrained coordinate polish after pair
release may harvest improvements that were infeasible before the pairs moved.

AXIS: incumbent affine recovery and active-pair release followed by tiny
gradient/wind/tangent one-turbine feasible line searches.
