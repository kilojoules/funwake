"""Affine basin perturbation with gradient-directed micro search.

HYPOTHESIS: The incumbent basin may still have small coherent row-scale
degrees of freedom that pair-only moves miss; a few global affine perturbations
can expose a nearby feasible layout before targeted gradient micro moves polish
the weakest turbines.

AXIS: low-dimensional affine layout perturbations plus short penalty polish and
gradient-directed active turbine line search after incumbent recovery.
