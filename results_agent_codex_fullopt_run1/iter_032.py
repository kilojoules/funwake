"""Affine recovery with wake-column group polish.

HYPOTHESIS: The last individual-turbine polish is likely blocked by active
spacing contacts. Moving small wake-aligned columns together can preserve those
contacts while changing wake exposure against neighboring rows.

AXIS: incumbent affine recovery and active-pair release followed by deterministic
wake-column mini-cluster translations and shears.
