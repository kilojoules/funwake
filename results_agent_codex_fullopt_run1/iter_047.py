"""Exact-size BO grid with staged augmented-Lagrangian NAdam.
...
while still finding a high-quality wind-aligned basin.

AXIS: BO-tuned multi-parameter exact grid plus staged AL-NAdam halving.
