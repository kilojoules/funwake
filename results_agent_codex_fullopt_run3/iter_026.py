"""Exact-size BO grid with wake-chain decoupling finish.
...
A different escape should explicitly identify high-pressure wake-aligned pairs
across the full wind rose and move the lower-value turbine plus nearby
low-output wake-chain neighbors crosswind. That crosses a different local
permutation than global smooth warps while still keeping changes sparse.
