"""Exact-size BO grid with coordinated weak-pair finish.
...
A different escape should move pairs of weak or boundary-contact turbines in
opposite directions before projection. That tests coordinated density
redistribution instead of the previous single-turbine, sector, row, and
wake-chain perturbations.
...
nesterov_momentum projected finish followed by coordinated weak-pair
anti-symmetric moves, wind-rose wake-chain decoupling, and one sector/contact
cleanup.
...
def optimize(sim, n_target, boundary, min_spacing, wd, ws, weights):
    ...
    pair_x, pair_y = weak_pair_finish(nesterov_x, nesterov_y)
